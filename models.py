    ...
    def print_pedigree(self):
        for individual in self.individuals:
            for allele in individual.haplotype.alleles:
                print(f"{individual.name},{individual.haplotype_class},{allele.marker.name},{allele.value},{allele.parent_value},{allele.mutation_value},{allele.mutation_probability}\n")
